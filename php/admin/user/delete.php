<?php
    ...
    $db = Database::connect();
    $req = $db->query("SELECT * FROM client WHERE NumCli = ?");

    if(!empty($_POST)) {
        $errors = array();
        $id = checkInput($_POST['id']);
        $statement = $db->prepare("DELETE FROM client WHERE NumCli = ?");
                ...
                <div class="admin-area">
                    <div class="suppression">
                        <?php 
                            ...
                            $req = $db->query("SELECT * FROM client where NumCli = $id");
                            while($donnees = $req->fetch()){
                                ...
                                echo '<div class="card-body">';
                                    ...
                                    echo '<h6 class="card-subtitle mb-2 text-muted">' .$donnees['NomCli']. ' ' .$donnees['PrenomCli']. '</h6>';
